...
var centerMenu = [
    ...
    ,{
        name: '视频收藏',
        url: '../shipinbofangqiCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '视频信息',
        url: './pages/shipinbofangqi/list.html'
    },

]

var adminurl =  "http://localhost:8080/shipinbofangqi/admin/dist/index.html#/login";
